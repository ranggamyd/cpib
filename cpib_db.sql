...
VALUES (
        ...
        'Laki-laki',
        'rangga',
        '5f8ac77c52c298a335791ed2ca59cf751.jpg'
    ), (
        7,
        'ADM-002',
        'REG-0023',
...
VALUES (1, 'REG-0001', 'SPL-001', 'jp1'), (2, 'REG-0002', 'SPL-002', 'jp2'), (3, 'REG-0003', 'SPL-002', 'jp2'), (
        4,
        'REG-0004',
        'SPL-001',
        'Udang Segar'
...
VALUES (
        ...
        ''
    ), (12, 'CKS-012', 'MONITORING', ''), (13, 'CKS-013', 'REKAMAN', '');
...
VALUES (1, 'PNG-001', 'P1', ''), (2, 'PNG-002', 'P2', ''), (3, 'PNG-003', 'P3', '');
...
VALUES (
        ...
        560,
        745,
        'JL. JENDRAL SUDIRMAN NO, 54 BANDUNG JAKARTA YOGYAKARTA SURABAYA KUNINGAN MAJALENGKA CIREBON',
        45,
        20,
        560,
        844,
        ...
        560,
        940,
        'PENGECEKAN - SORTASI - PENYIMPANAN - PEMINJAMAN - JUDI ONLINE - BANGKAR - ANJAY - COBAIN',
        45,
        20,
        560,
        1035,
...
VALUES (
        ...
        '',
        '',
        'Blok Lawang Gede RT 002 RW 002, Mertasinga, Gunungjati, Cirebon',
        ''
    ), (
        4,
        'SPL-002',
        ...
        '',
        '',
        'JL. Bandung No 57 JL. Bandung No 57 JL. Bandung No 57 MAJALAYA INDONESIA SUMATRA INDIA',
        ''
    );
...
VALUES (
        ...
        '0812',
        '',
        '669e40b854e5ed89bc374e62800f507d',
        '',
        'SPL-004',
        0
    );
...
ALTER TABLE `daftar_isian` ADD PRIMARY KEY (`id`);
...
ALTER TABLE `jenis_produk` ADD PRIMARY KEY (`id`);
...
ALTER TABLE `kategori_daftar_isian` ADD PRIMARY KEY (`id`);
...
ALTER TABLE `penanganan` ADD PRIMARY KEY (`id`);
...
ADD PRIMARY KEY (`id`),
ADD
    UNIQUE KEY `kd_pengajuan` (`kd_pengajuan`),
ADD
...
ALTER TABLE `penilaian` ADD PRIMARY KEY (`id`);
...
ALTER TABLE `penilaian_detail` ADD PRIMARY KEY (`id`);
...
ALTER TABLE `penilaian_notes` ADD PRIMARY KEY (`id`);
...
ALTER TABLE `penilaian_penanganan` ADD PRIMARY KEY (`id`);
...
ALTER TABLE `perbaikan` ADD PRIMARY KEY (`id`);
...
ALTER TABLE `perbaikan_detail` ADD PRIMARY KEY (`id`);
...
ALTER TABLE `sertifikat` ADD PRIMARY KEY (`id`);
...
ALTER TABLE `sertifikat_template` ADD PRIMARY KEY (`id`);
...
ALTER TABLE `tim_inspeksi` ADD PRIMARY KEY (`id`);
...
ALTER TABLE
    `daftar_isian` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 31;
...
ALTER TABLE
    `jenis_produk` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 6;
...
ALTER TABLE
    `kategori_daftar_isian` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 16;
...
ALTER TABLE
    `penanganan` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 4;
...
ALTER TABLE
    `pengajuan` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE
    `penilaian` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE
    `penilaian_detail` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE
    `penilaian_notes` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE
    `penilaian_penanganan` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE
    `perbaikan` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE
    `perbaikan_detail` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE
    `sertifikat` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE
    `sertifikat_template` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 10;
...
ALTER TABLE
    `suppliers` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 7;
...
ALTER TABLE
    `tim_inspeksi` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
