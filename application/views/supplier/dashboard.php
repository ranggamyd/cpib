        ...
        <div class="col-md-6">
            <div class="card mt-3 shadow shadow-sm">
                <div class="card-header d-flex">
                    <h5 class="mb-0"><i class="far fa-user-circle mr-2 mt-1"></i>Sertifikat saya</h5>
                    <a href="<?= base_url('sertifikat_supplier') ?>" type="button" class="btn btn-outline-primary ml-auto">Lihat Sertifikat</a>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
