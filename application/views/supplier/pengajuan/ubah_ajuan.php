  ...
  <div class="row">
    <div class="col-md-10">
      <div class="card shadow mb-4">
        <form action="<?= base_url('pengajuan_supplier/ubah') ?>" method="post" enctype="multipart/form-data">
          <div class="card-body">
            <div class="row">
              <div class="col-md-5">
            ...
            <div class="bg-info rounded pt-3 pb-3 text-light">
              <div class="row px-4">
                <div class="col">
                  ...
                  <div class="row">
                    <div class="col">
                      <input type="text" name="nama_miniplant" value="<?= set_value('nama_miniplant', $pengajuan->nama_miniplant) ?>" class="form-control mb-3 <?= form_error('nama_miniplant') ? 'is-invalid' : '' ?>" id="nama_miniplant" readonly required>
                    </div>
                    <div class="col-2">
