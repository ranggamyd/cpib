        ...
        <div class="container bg-info rounded pt-2 pb-3 text-light">
          <div class="row">
            <div class="col">
              ...
              <input type="text" name="nama_miniplant" value="<?= set_value('nama_miniplant', $supplier->nama_miniplant) ?>" class="form-control mb-3 <?= form_error('kd_supplier') ? 'is-invalid' : '' ?>" readonly>
            ...
            <div class="col">
              ...
              <input type="text" name="nama_pimpinan" value="<?= set_value('nama_pimpinan', $supplier->nama_pimpinan) ?>" id="nama_pimpinan" class="form-control mb-3 <?= form_error('nama_pimpinan') ? 'is-invalid' : '' ?>" readonly>
