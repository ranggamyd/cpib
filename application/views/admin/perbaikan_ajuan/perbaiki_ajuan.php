<div class="container-fluid">
  <h1 class="h3 mb-2 text-gray-800">Perbaiki Ajuan</h1>
  <hr>

  <div class="card shadow mb-4">
    <div class="card-body">
      <form action="<?= base_url('perbaikan_ajuan/perbaiki_ajuan') ?>" method="post">
        <div class="row">
          <div class="col-md-4">
            <label for="kd_perbaikan_ajuan">Kode Perbaikan Ajuan :</label>
            <input type="text" name="kd_perbaikan_ajuan" class="form-control mb-3" id="kd_perbaikan_ajuan" value="<?= $kd_perbaikan_ajuan_auto ?>" required readonly>
          </div>
          <div class="col-md-4">
          ...
          <div class="col-md-4">
            <label for="tgl_perbaikan_ajuan">Tanggal Perbaikan :</label>
            <input type="date" name="tgl_perbaikan_ajuan" value="<?= date('Y-m-d') ?>" class="form-control mb-3" id="tgl_perbaikan_ajuan" required>
          </div>
        </div>
          ...
          <div class="col">
            ...
            <select name="kd_produk" id="kd_produk" class="form-control mb-3" required>
              <?php foreach ($jenis_produk as $jp) : ?>
                <option value="<?= $jp['kd_jenis_produk'] ?>" <?= $pengajuan->kd_jenis_produk == $spl['kd_jenis_produk'] ? 'selected' : '' ?>><?= $jp['jenis_produk'] ?></option>
              <?php endforeach ?>
            </select>
          </div>
        </div>
