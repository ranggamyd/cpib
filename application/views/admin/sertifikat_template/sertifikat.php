          ...
          <div class="collapse" id="<?= $item['kd_sertifikat'] ?>">
            <div class="card-body bg-light">
              ...
              <div class="d-flex justify-content-between align-items-center mt-3">
                ...
                <div class="">
                  <a href="<?= base_url('sertifikat_template/edit/') . $item['kd_sertifikat'] ?>" class="badge badge-primary" data-toggle="tooltip" data-placement="right" title="Edit"><i class="fa fa-fw fa-edit"></i></a>
                  <a href="<?= base_url('sertifikat_template/hapus/') . $item['kd_sertifikat'] ?>" class="badge badge-danger" data-toggle="tooltip" data-placement="right" title="Hapus"><i class="fas fa-trash-alt"></i></a>
                </div>
              </div>
            </div>
          </div>
...
<div class="modal fade" id="tambah_sertifikat" tabindex="-1" role="dialog" aria-labelledby="tambah_sertifikatLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <form action="<?= base_url('sertifikat_template/tambah') ?>" method="post" enctype="multipart/form-data">
